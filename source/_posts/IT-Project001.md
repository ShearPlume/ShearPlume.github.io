...
最后向前端发送一个“ActorReady”消息，通知其后端已准备就绪，同时传输上文的巨大Set给前端，并根据配置文件把图片资源加载并存储起来（也就是我们开始游戏时看到的进度条加载界面）
...
再回到CommandDemo来看实际如何使用：![image-20230202151115482](IT-Project001/image-20230202151115482.png)
